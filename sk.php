<?php
$lang = array(
"H1_informacie" =>  "Telefón bol ohlásený v roku 2015 a na trh sa dostal v roku 2016 podľa pravidelnosti s akou
                            Apple vydáva svoje telefóny je aj tento odpoveďou na model iPhone 6 ktorý mal mnohé
                            problém ktorým sa „S-kový“ model snaží vyvarovať ako ľahké ohýbanie ktoré dokázalo
                            poškodiť telefón aj ked ho mal používateľ iba vo vrecku. Tento problém rieši Apple novou
                            zliatinou hliníku ktorá sa používa aj v leteckom priemysle a spravil telefon hrubším a
                            odolnejším.",

"testujem" => "slovakia",

"Informacie2" => "Model 6s je posledným na ktorom pracoval Steve Jobs pred svojou smrťou a pokladá sa za najväčší úspech Applu.",

"HW1" => "Vnútro je narozdiel od vonkajšieho dizajnu všetko nové. Použitý je nový chip Apple A9 ktorý
